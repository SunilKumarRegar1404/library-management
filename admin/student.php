  ...
  document.getElementById("main").style.marginLeft= "0";
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            $q=mysqli_query($db,"SELECT first,last,username,roll,email,phone FROM `data` WHERE username like '%$_POST[search]%' ");
    ...
    /* if button is not clicked*/
            ...
            $res=mysqli_query($db,"SELECT first,last,username,roll,email,phone FROM `data`;");
